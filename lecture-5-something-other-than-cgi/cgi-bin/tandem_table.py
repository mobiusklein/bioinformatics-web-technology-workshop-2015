...
tandem_table_row_template = open("tandem_table.html").read()
...
row_buffer = []
for ion in observed_precursor.tandem_data:
    row_buffer.append(tandem_table_row_template.format(ion=ion))
